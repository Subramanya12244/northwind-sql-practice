# Q76. Customer–Category Combinations
...
|-------------|-------------|
| contact_name | Contact name of the customer |
...
*(Sample values are illustrative, based on the standard Northwind dataset. Showing first 5 of 91 customers × 8 categories = **728 rows**)*

## Result Size

91 customers × 8 categories = **728 rows**
...
**Practical use case:** a customer–category matrix is the starting point for a category purchase coverage report. By LEFT JOINing this CROSS JOIN result to actual order history, you can produce a grid showing which customers have (and haven't) purchased from each category — with zero-purchase cells shown explicitly as 0 rather than missing rows.
...
**Interview Takeaway:** By Q76, CROSS JOIN patterns are recognised instantly. Two tables, no ON, N × M rows.

📄 **SQL File:** [`Q76_Customer-Category_Combinations.sql`](./Q76_Customer-Category_Combinations.sql)
